...
const AboutRail = () => {
  ...
  return (
    <div className='flex flex-col'>
      <div className='flex md:flex-row flex-col h-fit p-20 md:justify-between md:items-center gap-5 bg-[#224e9d]'>
      ...
      <div className='w-full flex bg-[#18364b] py-[2%] justify-center gap-[10%] items-center'>
        <div ref={ref1} className='w-fit flex flex-col-reverse h-fit'>
        ...
        <div ref={ref2} className='w-fit h-fit border-r-2 border-l-2 px-[10%] border-white flex flex-col-reverse'>
        ...
        <div ref={ref3} className='w-fit p-[2%] flex flex-col-reverse'>
