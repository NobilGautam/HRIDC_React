  ...
  return (
    <div className='relative h-[90vh] flex justify-center items-center flex-col'>
      ...
      <div className='relative z-10 flex flex-col justify-center items-center'>
        <h1 className='text-white text-[4rem] font-bold'>HARYANA RAIL</h1>
        <h1 className='text-white text-[4rem] font-bold'>INFRASTRUCTURE</h1>
        <p className='text-white text-[1.2rem] font-light max-w-[60%] text-center'>
