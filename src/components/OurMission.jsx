  ...
  return (
    <>
        <div className='pt-10 pl-[5%] mb-10'>
            ...
            <p className='text-[1.2rem] font-light text-gray-600'>going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
        </div>
        <div className='flex flex-wrap gap-y-5 gap-x-4 justify-center items-center'>
