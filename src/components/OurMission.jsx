  ...
  return (
    <>
      ...
      <div className='relative w-[90%] mx-auto'>
        ...
        <div className="swiper-button-prev custom-nav-prev absolute top-1/2 left-2 transform -translate-y-1/2 z-10 cursor-pointer">
        ...
        <div className="swiper-button-next custom-nav-next absolute top-1/2 right-2 transform -translate-y-1/2 z-10 cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 text-gray-900 dark:text-white">
