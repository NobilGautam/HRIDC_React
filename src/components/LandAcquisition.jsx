...
const LandAcquisition = () => {
    ...
    //     {
    //         vcn: "HRIDC/2024/15",
    //         service: "As per Vacancy Notice",
    //         title: "For the Post of Executive/General on Contract basis at anywhere in the State of Haryana",
    //         posts: "02",
        ...
        <div>
            ...
            <div className='flex justify-center my-4'>
                <div className='flex w-[90%] px-[1%]'>
                    <h1 className='font-semibold w-[20%] text-[1.2rem]'>S. No.</h1>
                    <h1 className='font-semibold w-[60%] text-[1.2rem]'>Title</h1>
                    <h1 className='font-semibold w-[20%] text-[1.2rem] text-right pr-[2%]'>Actions</h1>
                </div>
            </div>
                ...
                {landAcqData.map((item, index) => (
                    <div data-aos="fade-zoom-in" className={`flex flex-row w-[90%] py-4 rounded-xl ${index % 2 === 0 ? 'bg-[#d2e2f5]' : 'bg-[#cbd3df]'}`}>
                        <div className='w-[20%] flex justify-start pl-[5%] items-center'>
                            <h1 className='font-semibold text-[1.2rem]'>{item.sno}</h1>
                        </div>
