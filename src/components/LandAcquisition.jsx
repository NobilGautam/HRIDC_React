...
const LandAcquisition = () => {
  ...
  return (
    <div>
        <div>
            <h1 className='text-[2rem] font-bold my-10 ml-[5%] text-[#19155e]'>LAND ACQUISITION</h1>
            ...
            <div className='flex items-center flex-col gap-4 mb-10  '>
                {landAcqData.map((item, index) => (
                    <div data-aos="fade-zoom-in" className={`flex flex-row w-[90%] py-4 rounded-xl ${index % 2 === 0 ? 'bg-[#d2e2f5] hover:bg-[#7fa4ce]' : 'bg-[#cbd3df] hover:bg-[#7fa4ce]'}`}>
