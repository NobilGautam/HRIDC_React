  ...
  return (
    <div className='py-20 flex flex-col gap-10'>
        <div className='flex flex-col justify-start'>
            <h1 className='text-[3rem] font-bold px-[5%]'>GAZETTE NOTIFICATIONS</h1>
            ...
            <div className="flex flex-col md:max-h-[300px] md:max-w-[70%] py-4 items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <div className="flex flex-col justify-between items-start p-4 py-8 leading-normal">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                      Variations of passages of Lorem Ipsum available, but the majority have alteration in some form, by injected humour, or randomised variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised.
                    </p>
